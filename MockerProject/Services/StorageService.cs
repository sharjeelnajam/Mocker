...
namespace MockerProject.Services;
...
internal static class StorageService
{
    ...
    public static FilePickerFileType IMG { get; } = new("image")
    {
        Patterns = new[] { "*.PNG" },
        MimeTypes = new[] { "image/png" }
    };
    public static FilePickerFileType Proj { get; } = new("dsproj")
    {
        Patterns = new[] { "*.dsproj" },
        AppleUniformTypeIdentifiers = new[] { "public.dsproj" },
        MimeTypes = new[] { "application/dsproj" }
    };
